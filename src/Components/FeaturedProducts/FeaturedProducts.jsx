...
<i onClick={()=>addProductToWhishlist(product.id)} className={`fa-regular fa-heart fs-3 text-dark heart1 ${heartStatus1} `}  ></i>
<i onClick={()=>removeProductformWishlist(product.id)} className={`fa-regular fa-heart text-danger fs-3 heart2 ${heartStatus2} `}    ></i>
